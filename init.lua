...
require("four.impatient")
require("four.indentline")
require("four.alpha")
require("four.autocommands")
require("four.renamer")
require("four.colorizer")
require("four.whichkey")
